              ...
              {viewMode === 'comparison' && timeView === 'yearly' ? (
                <BarChart data={chartData} margin={{ top: 20, right: 30, left: 20, bottom: 80 }}>
                      ...
                      if (active && payload && payload.length) {
                        ...
                        return (
                          <div className="bg-white p-3 border border-gray-200 rounded-lg shadow-lg cursor-pointer">
                            ...
                            <p className="text-xs text-blue-500 mt-1">Click to view bills</p>
                          </div>
                        );
                      }
                      return null;
                  ...
                  <Bar 
                    ...
                    radius={[4, 4, 0, 0]}
                    onClick={(data) => handleChartClick(data, 'hotel')}
                  ...
                  {selectedHotels.map((hotelId, index) => {
                    ...
                    return (
                      <Line
                        ...
                        dot={{ r: 4 }}
                        connectNulls={false}
                        onClick={(data, event) => handleChartClick({...data, month: data.payload?.month}, 'month')}
                        style={{ cursor: 'pointer' }}
                      />
                    );
                  })}
