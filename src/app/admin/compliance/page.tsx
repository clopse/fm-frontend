...
// Mock compliance tasks from your JSON data - filtered to mandatory only
const mandatoryTasks: TaskInfo[] = [
  { task_id: 'fire_risk_assessment', label: 'Annual Fire Risk Assessment', frequency: 'Annually', category: 'Fire', mandatory: true, points: 20 },
  { task_id: 'fire_alarm_service_certificate', label: 'Quarterly Fire Alarm Service Certificate', frequency: 'Quarterly', category: 'Fire', mandatory: true, points: 20 },
  { task_id: 'fire_extinguisher_certificate', label: 'Annual Fire Extinguisher Service Certificate', frequency: 'Annually', category: 'Fire', mandatory: true, points: 20 },
  { task_id: 'emergency_light_cert', label: 'Annual Emergency Lighting Test Certificate', frequency: 'Annually', category: 'Fire', mandatory: true, points: 20 },
  { task_id: 'sprinkler_service_certificate', label: 'Annual Sprinkler System Service Certificate', frequency: 'Annually', category: 'Fire', mandatory: true, points: 20 },
  { task_id: 'dry_riser_test_certificate', label: 'Annual Dry Riser Test Certificate', frequency: 'Annually', category: 'Fire', mandatory: true, points: 20 },
  { task_id: 'ansul_system_check', label: 'Annual Ansul System Certification', frequency: 'Annually', category: 'Fire', mandatory: true, points: 20 },
  { task_id: 'weekly_fire_alarm_test', label: 'Weekly Fire Alarm Test', frequency: 'Weekly', category: 'Fire', mandatory: true, points: 15 },
  ...
  { task_id: 'weekly_emergency_exit_check', label: 'Weekly Emergency Exit Route Check', frequency: 'Weekly', category: 'Fire', mandatory: true, points: 15 },
  ...
  { task_id: 'gas_safety_certificate', label: 'Annual Gas Safety Certificate', frequency: 'Annually', category: 'Gas', mandatory: true, points: 20 },
  { task_id: 'boiler_service', label: 'Boiler Service Report', frequency: 'Annually', category: 'Gas', mandatory: true, points: 20 },
  { task_id: 'legionella_risk_assessment', label: 'Legionella Risk Assessment (Every 2 Years)', frequency: 'Biennially', category: 'Water', mandatory: true, points: 20 },
  { task_id: 'tank_inspection_annual', label: 'Annual Water Tank Inspection', frequency: 'Annually', category: 'Water', mandatory: true, points: 20 },
  { task_id: 'tmv_annual_service', label: 'Annual TMV (Thermostatic Mixing Valve) Service', frequency: 'Annually', category: 'Water', mandatory: true, points: 20 },
  { task_id: 'passenger_lift_cert', label: 'Passenger Lift Inspection Certificate (6-Monthly)', frequency: 'Twice Annually', category: 'Lifts', mandatory: true, points: 20 },
  ...
  { task_id: 'pest_control_inspection', label: 'Monthly Pest Control Contractor Inspection', frequency: 'Monthly', category: 'Food Safety', mandatory: true, points: 20 },
  { task_id: 'fridge_temp_log', label: 'Daily Fridge and Freezer Temperature Check', frequency: 'Daily', category: 'Food Safety', mandatory: true, points: 20 },
  { task_id: 'safety_statement_review', label: 'Annual Safety Statement Review', frequency: 'Annually', category: 'Health & Safety', mandatory: true, points: 20 },
